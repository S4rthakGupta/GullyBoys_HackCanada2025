...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-6 bg-gray-950 text-white">
      {/* Hero Section */}
      <section className="max-w-4xl text-center space-y-6">
        <h1 className="text-5xl font-bold tracking-tight">
          MediQueue: Streamlining Clinic Check-ins
        </h1>
      ...
      <section className="grid md:grid-cols-3 gap-6 max-w-5xl">
        <Card className="p-6 bg-gray-900 border-gray-800">
          <CardContent className="space-y-4">
            <h2 className="text-xl font-semibold">Instant Check-in</h2>
